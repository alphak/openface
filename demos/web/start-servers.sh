...
./demos/web/websocket-server-cqrcb_final.py --port $WEBSOCKET_PORT 2>&1 | tee $WEBSOCKET_LOG &
#./demos/web/websocket-server-cqrcb.py --cuda --port $WEBSOCKET_PORT 2>&1 | tee $WEBSOCKET_LOG &
wait
